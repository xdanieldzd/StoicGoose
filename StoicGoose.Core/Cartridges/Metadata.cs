...
namespace StoicGoose.Core.Cartridges
{
    public class Metadata
    {
        ...
        public string PublisherCode => publishers.TryGetValue(PublisherId, out (string code, string name) value) ? value.code : "???";
        public string PublisherName => publishers.TryGetValue(PublisherId, out (string code, string name) value) ? value.name : "(Unknown)";
        ...
        public int SaveSize => saveSizes.TryGetValue(SaveType, out int value) ? value : 0;
