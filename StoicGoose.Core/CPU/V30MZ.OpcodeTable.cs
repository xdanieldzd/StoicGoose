namespace StoicGoose.Core.CPU
{
	public sealed partial class V30MZ
	{
		...
		readonly static Instruction[] instructions = new Instruction[256]
		{
			...
			/* 0xE4 */      /* IN Ib AL */                  (cpu) => { cpu.ax.Low = cpu.ReadRegister8(cpu.ReadOpcodeIb()); return 6; },
							/* IN Ib AX */                  (cpu) => { cpu.ax.Word = cpu.ReadRegister16(cpu.ReadOpcodeIb()); return 6; },
							/* OUT Ib AL */                 (cpu) => { cpu.WriteRegister8(cpu.ReadOpcodeIb(), cpu.ax.Low); return 6; },
							/* OUT Ib AX */                 (cpu) => { cpu.WriteRegister16(cpu.ReadOpcodeIb(), cpu.ax.Word); return 6; },
			...
			/* 0xEC */      /* IN AL DX */                  (cpu) => { cpu.ax.Low = cpu.ReadRegister8(cpu.dx.Word); return 4; },
							/* IN AX DX */                  (cpu) => { cpu.ax.Word = cpu.ReadRegister16(cpu.dx.Word); return 4; },
							/* OUT DX AL */                 (cpu) => { cpu.WriteRegister8(cpu.dx.Word, cpu.ax.Low); return 4; },
							/* OUT DX AX */                 (cpu) => { cpu.WriteRegister16(cpu.dx.Word, cpu.ax.Word); return 4; },
