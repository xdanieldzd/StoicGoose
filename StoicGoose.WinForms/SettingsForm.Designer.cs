...
namespace StoicGoose.WinForms
{
	partial class SettingsForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.tvSettings = new StoicGoose.WinForms.Windows.Controls.TreeViewEx();
			this.tlpSettings = new StoicGoose.WinForms.Windows.Controls.TableLayoutPanelEx();
		...
		private StoicGoose.WinForms.Windows.Controls.TreeViewEx tvSettings;
		private StoicGoose.WinForms.Windows.Controls.TableLayoutPanelEx tlpSettings;
