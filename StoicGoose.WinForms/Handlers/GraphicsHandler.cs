...
namespace StoicGoose.WinForms.Handlers
{
    ...
    public class GraphicsHandler
    {
        ...
        readonly Dictionary<string, Matrix4Uniform> iconModelviewMatrices = [];
        ...
        readonly Dictionary<string, Texture> iconTextures = [];
        ...
        readonly List<string> activeStatusIcons = [];
        ...
        private void InitializeVertexArray()
        {
            ...
            {
                new() { Position = new Vector2(0f, 1f), TexCoord = new Vector2(0f, 1f) },
                new() { Position = new Vector2(1f, 0f), TexCoord = new Vector2(1f, 0f) },
                new() { Position = new Vector2(0f, 0f), TexCoord = new Vector2(0f, 0f) },

                new() { Position = new Vector2(0f, 1f), TexCoord = new Vector2(0f, 1f) },
                new() { Position = new Vector2(1f, 1f), TexCoord = new Vector2(1f, 1f) },
                new() { Position = new Vector2(1f, 0f), TexCoord = new Vector2(1f, 0f) },
            };
