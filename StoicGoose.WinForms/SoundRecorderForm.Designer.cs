...
namespace StoicGoose.WinForms
{
	partial class SoundRecorderForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.ftbWaveFile = new StoicGoose.WinForms.Windows.Controls.FileTextBox();
			...
			this.ftbWaveFile.DialogMode = StoicGoose.WinForms.Windows.Controls.FileTextBoxDialogMode.Save;
		...
		private Windows.Controls.FileTextBox ftbWaveFile;
