...
namespace StoicGoose.Emulation.Machines
{
	public partial class WonderSwan
	{
		...
		private void FillMetadata()
		{
			...
			Metadata["machine/display/width"] = DisplayController.ScreenWidth;
			Metadata["machine/display/height"] = DisplayController.ScreenHeight;
			Metadata["machine/display/refresh"] = DisplayController.VerticalClock;

			Metadata["machine/input/controls"] = "start, b, a, x1, x2, x3, x4, y1, y2, y3, y4";
			Metadata["machine/input/hardware"] = "volume";

			Metadata["interface/files/romfilter"] = "WonderSwan ROMs (*.ws;*.wsc)|*.ws;*.wsc";
