	...
	public class ImGuiScreenWindow : ImGuiWindowBase
	{
		...
		protected override void DrawWindow(object userData)
		{
			...
			if (ImGui.Begin(WindowTitle, ref isWindowOpen))
			{
				...
				//ImGui.TextColored(ImGui.ColorConvertU32ToFloat4(ImGui.GetColorU32(ImGuiCol.WindowBg)), $"IsFocused: {IsFocused}");
				...
				{
					ImGui.SliderInt("##size", ref windowScale, 1, 3, "Scale %dx");
					ImGui.EndPopup();
				}
