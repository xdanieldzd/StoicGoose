...
namespace StoicGoose.Common.OpenGL.Vertices
{
    public sealed class VertexArray : IDisposable
    {
        ...
        {
            if (pointerTypeTranslator.TryGetValue(type, out VertexAttribPointerType value))
                return value;
            else
        ...
        {
            if (integerTypeTranslator.TryGetValue(type, out VertexAttribIntegerType value))
                return value;
            else
        ...
        {
            if (drawElementsTypeTranslator.TryGetValue(type, out DrawElementsType value))
                return value;
            else
