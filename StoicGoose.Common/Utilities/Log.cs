...
namespace StoicGoose.Common.Utilities
{
    ...
    public static class Log
    {
        ...
        public static void WriteEvent(LogSeverity severity, object source, string message)
        {
            ...
            var eventLevel = severityToEventLevelMapping.TryGetValue(severity, out LogEventLevel value) ? value : LogEventLevel.Verbose;
    ...
    class TextWriterSink(TextWriter writer, ITextFormatter formatter) : ILogEventSink
    {
        readonly TextWriter textWriter = writer;
        readonly ITextFormatter textFormatter = formatter ?? throw new ArgumentNullException(nameof(formatter));
